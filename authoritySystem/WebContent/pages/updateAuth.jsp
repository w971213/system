        	...
        	$("#updateUserAuth").click(function(){
            	...
            	if(oldId==""){
            		if(newId==""){
            			...
            			if(confirm('确认修改权限？')){
                			location.href="${pageContext.request.contextPath}/user/updateAuth.action?ids="+ids+"&userId="+${UserInfo.userId};	
                		}
            		}
            	}else{
            		if(newId==""){
            			if(confirm('确认清空权限？')){
                			location.href="${pageContext.request.contextPath}/user/deleteUserAuth.action?userId="+${UserInfo.userId};	
                		}
            		}else if(newId==oldId){
            			alert("修改权限一致")
                		return;	
